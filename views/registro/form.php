...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <main class="flex-grow py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="px-6 py-4 bg-sky-800 text-white">
                    <h1 class="text-2xl font-bold">Registro de Afiliación</h1>
                    <p class="mt-1">Completa el formulario para afiliarte</p>
                </div>
                
                <div class="px-6 py-6">
                    <!-- Opción para cargar INE -->
                    <div class="mb-8 border border-gray-200 rounded-lg p-4 bg-gray-50">
                        <h2 class="text-lg font-semibold text-gray-700 mb-4">Acelera tu registro con INE</h2>
                        <p class="text-gray-600 mb-4">Puedes cargar tu credencial de elector para llenar automáticamente algunos campos del formulario.</p>
                        
                        <div class="drop-zone p-6 rounded-lg flex flex-col items-center justify-center cursor-pointer" id="dropzone">
                            <i class="fas fa-id-card text-4xl text-gray-400 mb-3"></i>
                            <p class="text-gray-600 mb-1">Arrastra tu imagen aquí o haz clic para seleccionar</p>
                            <p class="text-xs text-gray-500">Formatos aceptados: JPG, PNG (Máx. 5MB)</p>
                        ...
                        <div id="loading-indicator" class="mt-4 text-center hidden">
                            ...
                            <p class="mt-2 text-gray-600">Procesando tu credencial...</p>
                        </div>
                        
                        <div id="ocr-result" class="mt-4 p-3 bg-green-100 text-green-700 rounded-lg hidden">
                            <i class="fas fa-check-circle mr-2"></i> 
                            <span>Información extraída correctamente. El formulario ha sido prellenado.</span>
                        </div>
                        
                        <div id="ocr-error" class="mt-4 p-3 bg-red-100 text-red-700 rounded-lg hidden">
                            <i class="fas fa-exclamation-circle mr-2"></i>
                            <span>No se pudo extraer la información. Por favor, llena el formulario manualmente.</span>
                        </div>
                    </div>
                    
                    <!-- Formulario de registro -->
                    <form id="registro-form" method="POST" action="<?= APP_URL ?>/register/process" enctype="multipart/form-data">
                        <!-- Token CSRF -->
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                <h3 class="text-lg font-medium text-gray-700 mb-3 pb-2 border-b border-gray-200 mt-6">Información de Contacto y Domicilio</h3>
                            </div>
                          ...
                          <!-- Estado -->
                            ...
                            <div class="col-span-2 mt-6 flex justify-end">
                                <a href="<?= APP_URL ?>/" class="mr-4 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                    Cancelar
                                </a>
                                <button 
                                    type="submit" 
    ...
    <!-- Incluir Tesseract.js v5 para OCR en el navegador -->
    <script src="https://cdn.jsdelivr.net/npm/tesseract.js@5/dist/tesseract.min.js"></script>
    <script src="./js/ine_processor.js"></script>
</body>
</html>